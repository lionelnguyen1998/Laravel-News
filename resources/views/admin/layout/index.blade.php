...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="admin_acess/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="admin_acess/bower_components/datatables-responsive/css/dataTables.responsive.css" rel="stylesheet">
...
<body>
    ...
    <script src="admin_acess/bower_components/DataTables/media/js/jquery.dataTables.min.js"></script>
    <script src="admin_acess/bower_components/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.min.js"></script>
    ...
    <script type="text/javascript" language="javascript" src="admin_acess/ckeditor/ckeditor.js" ></script>
