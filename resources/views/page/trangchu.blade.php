	            ...
	            <div class="panel panel-default">            
	            	...
	            	<div class="panel-body">
					    ...
					    <div class="row-item row">
		                	...
		                	<?php 
		                	$data = $tl->tintuc->where('NoiBat',1)->sortByDesc('create_at')->take(5);//luu 5 tin tuc noi bat nhat
		                	$tin1=$data->shift();//lay ra mot tin trong data, ham shift() tra ve kieu mang
		                	?>
		                	<div class="col-md-8 border-right">
		                		<div class="col-md-5">
			                        <a href="tintuc/{{$tin1['id']}}/{{$tin1['TieuDeKhongDau']}}.html">
			                            <img class="img-responsive" src="upload/hinhanh/tintuc/{{$tin1->Hinh}}" alt="">
			                        </a>
			                    </div>
